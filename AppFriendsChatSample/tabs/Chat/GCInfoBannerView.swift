...
class GCInfoBannerView: UIView, UITextFieldDelegate {
    ...
    override func updateConstraints() {
        ...
        if self.topViewController?.edgesForExtendedLayout == .all ||
            self.topViewController?.edgesForExtendedLayout == .top {
        ...
        NSLayoutConstraint.activate([
            NSLayoutConstraint(item: self, attribute: .top,
                               relatedBy: .equal, toItem: self.superview,
                               attribute: .top, multiplier: 1.0, constant: topOffset),
            ...
            // closeButton
            NSLayoutConstraint(item: self.closeButton, attribute: .centerY,
                               relatedBy: .equal, toItem: self.textField,
                               attribute: .centerY, multiplier: 1.0, constant: 0.0),
            NSLayoutConstraint(item: self.closeButton, attribute: .left,
                               relatedBy: .equal, toItem: self.textField,
                               attribute: .right, multiplier: 1.0, constant: 5.0),

            // textField
            NSLayoutConstraint(item: self.textField, attribute: .centerY,
                               relatedBy: .equal, toItem: self,
                               attribute: .centerY, multiplier: 1.0, constant: 0.0),
            NSLayoutConstraint(item: self.textField, attribute: .centerX,
                               relatedBy: .equal, toItem: self,
                               attribute: .centerX, multiplier: 1.0, constant: -10.0),
            NSLayoutConstraint(item: self.textField, attribute: .width,
                               relatedBy: .equal, toItem: self,
                               attribute: .width, multiplier: 0.8, constant: 0.0),

            // bottom divider
            NSLayoutConstraint(item: self.divider, attribute: .bottom,
                               relatedBy: .equal, toItem: self,
                               attribute: .bottom,
                               multiplier: 1.0, constant: 0.0),
            NSLayoutConstraint(item: self.divider, attribute: .height,
                               relatedBy: .equal, toItem: nil,
                               attribute: .notAnAttribute, multiplier: 0.0, constant: 1.0),
            NSLayoutConstraint(item: self.divider, attribute: .width,
                               relatedBy: .equal, toItem: self,
